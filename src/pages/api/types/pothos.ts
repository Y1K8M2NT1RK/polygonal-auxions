/* eslint-disable */
import type { Prisma, User, UserFiles, Purpose, AuthPayload, Follow, Artwork, ArtworkFile, ArtworkGizmo, Comment, ArtworkRanks, Ranks, RankTypes } from "../node_modules/@prisma/client";
